...
python /lustre/projects/SethCommichaux/MTDNA/Protist_pipeline_scripts_DB/get_taxa_long_read.py $i.mt.blast $x;
python /lustre/projects/SethCommichaux/MTDNA/Protist_pipeline_scripts_DB/get_taxa_long_read.py $i.plastid.blast $x
...
python /lustre/projects/SethCommichaux/MTDNA/Protist_pipeline_scripts_DB/get_groups_long_read.py $i.mt.blast.results.protist /lustre/projects/SethCommichaux/MTDNA/taxa_info/fullnamelineage.dmp /lustre/projects/SethCommichaux/MTDNA/taxa_info/nodes.dmp $x;
python /lustre/projects/SethCommichaux/MTDNA/Protist_pipeline_scripts_DB/get_groups_long_read.py $i.plastid.blast.results.protist /lustre/projects/SethCommichaux/MTDNA/taxa_info/fullnamelineage.dmp /lustre/projects/SethCommichaux/MTDNA/taxa_info/nodes.dmp $x;
